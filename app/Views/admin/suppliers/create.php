...
<div class="card border-info mt-3">
    <div class="card-header">
        <h2 class="text-info">Datos del nuevo proveedor</h2>
    </div>
    <div class="card-body">
        <form id="formSupplierData" name="formSupplierData" action="<?php echo base_url('admin/suppliers/store'); ?>" method="post" accept-charset="utf-8" autocomplete="off">
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="taxnumber" name="taxnumber" placeholder="Ingrese el NIT del proveedor" value="<?= old('taxnumber') ?>">
                        </div>
                ...
                <div class="col-sm-12 col-md-8">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="company" name="company" placeholder="Ingrese el nombre de la empresa proveedora" value="<?= old('company') ?>">
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="address" name="address" placeholder="Ingrese la dirección de la empresa" value="<?= old('address') ?>">
                        </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="seller" name="seller" placeholder="Ingrese el nombre del vendedor" value="<?= old('seller') ?>">
                        </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Ingrese el correo electrónico" value="<?= old('email') ?>">
                        </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Ingrese el correo electrónico" value="<?= old('phone') ?>">
                        </div>
