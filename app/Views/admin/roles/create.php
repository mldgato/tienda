...
<h1>Crear nuevo rol <i class="fas fa-user-tag"></i></h1>
<?= $this->endSection(); ?>

<?= $this->section('content'); ?>
<div class="card border-info mt-3">
    <div class="card-header">
        <h2 class="text-info">Nombre del nuevo rol</h2>
    </div>
    <div class="card-body">
        <form id="formSupplierData" name="formSupplierData" action="<?php echo base_url('admin/roles/store'); ?>" method="post" accept-charset="utf-8" autocomplete="off">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="rolname" name="rolname" placeholder="Ingrese el nombre del nuevo rol" value="<?= old('rolname') ?>">
                        </div>
