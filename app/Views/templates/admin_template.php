    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <img src="../../dist/img/ChinosLogo@0.5x.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <div class="image">
                        <?php
                            if(session('image') == null){
                                ...
                                echo '<img src="../../dist/img/users/'.session('image').'" class="img-circle elevation-2" alt="User Image">';
                            }
                        ?>
